...
class Lexer(object):
    ...
    def display_console(self):
        ...
        for lexeme in display_list:
            length_1 = len(lexeme.line)
            length_2 = len(lexeme.lexeme)
        ...
        for lexeme in display_list:
            spacing_1 = ((longest_1 - len(lexeme.line)) + 2) * " "
            spacing_2 = ((longest_2 - len(lexeme.lexeme)) + 20) * " "
            print(lexeme.line, spacing_1 + "|", lexeme.lexeme, spacing_2 + "|", lexeme.token)
